...
import { Offer, OfferDocument } from 'src/models/offer.schema';
import { CreateReferralDto } from 'src/dto/create-referral.dto';
import { Referral, ReferralDocument } from 'src/models/referral.schema';
import { CreateInterviewDto } from 'src/dto/create-interview.dto';
import { UpdateInterviewDto } from '../dto/update-interview.dto';
import { Interview, InterviewDocument } from 'src/models/interview.schema';
import { CreateFeedbackDto } from 'src/dto/create-feedback.dto';
import { AssessmentResult, AssessmentResultDocument } from 'src/models/assessment-result.schema';
import { UpdateFeedbackDto } from 'src/dto/update-feedback.dto';
...
import { Application, ApplicationDocument } from 'src/models/application.schema';
import { JobTemplate, JobTemplateDocument } from 'src/models/job-template.schema';
import { JobRequisition, JobRequisitionDocument } from 'src/models/job-requisition.schema';
import { CreateJobTemplateDto } from 'src/dto/create-job-template.dto';
import { CreateJobRequisitionDto } from 'src/dto/create-job-requisition.dto';
import { Onboarding, OnboardingDocument } from 'src/models/onboarding.schema';
import { ApplicationStatus } from 'src/enums/application-status.enum';
import { Contract, ContractDocument } from 'src/models/contract.schema';
...
import { ApplicationStatusHistory, ApplicationStatusHistoryDocument } from 'src/models/application-history.schema';
import { OnboardingService } from './onboarding.service';
import { OfferResponseStatus } from 'src/enums/offer-response-status.enum';
